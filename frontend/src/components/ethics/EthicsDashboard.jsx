        ...
        <div style={{ display: "grid", gridTemplateColumns: "360px 1fr", gap: 20, alignItems: "start" }}>
          ...
          {selected ? (
            <div>
              ...
              {/* ── Creatives sub-tab ── */}
              {panelTab === "creatives" && (
                <SectionCard title="Ad Creatives" subtitle="Visual assets generated for this campaign">
                  {selected.output_files?.length ? (
                    <CreativesViewer creatives={selected.output_files} />
                  ) : (
                    <div className="empty-state" style={{ padding: "32px 16px" }}>
                      <Image size={36} className="empty-state__icon" />
                      <p className="empty-state__text">No creatives generated yet</p>
                      <p className="empty-state__hint">Creatives are generated by the Study Coordinator</p>
                    </div>
                  )}
                </SectionCard>
              )}
